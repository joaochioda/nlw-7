    ...
    return (
        ...
        <form className="my-4 w-full" onSubmit={handleSumibitFeedback}>
            ...
            <ScreenShootButton onScreenshotTook={setScreenshot} screenshot={screenshot}/>
                <button type="button" disabled={comment.length === 0} type="submit" className="p-2 bg-brand-500 rounded-md border-transparent flex-1 flex justify-center items-center text-sm hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500">
                    Enviar feedback
                </button>
            </footer>
        </form>
